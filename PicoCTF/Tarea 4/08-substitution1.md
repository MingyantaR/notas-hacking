...
## Solucion
al descargar el mensaje y revisarlo obtenemos esto:
```
...
```
ahora vamos a esta [pagina](https://www.dcode.fr/monoalphabetic-substitution) y obtenemos el siguiente texto junto con la bandera al final:
```
...
```
la bandera al parecer se decodifico con un error quedaria asi:
