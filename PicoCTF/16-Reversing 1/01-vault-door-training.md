...
## Solucion
descargamos el archivo del reto, y revisamos el contenido con un cat
```
...
```
podemos observar que la bandera se encuentra al final del codigo: picoCTF{w4rm1ng_Up_w1tH_jAv4_000WWjzOMm7}
## Notas
- 
## Referencias
- 