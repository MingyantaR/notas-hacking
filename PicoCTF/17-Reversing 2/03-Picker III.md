## Descripcion
Can you figure out how this program works to get the flag? Connect to the program with netcat: `$ nc saturn.picoctf.net 50727` The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/525/picker-III.py).
## Solucion
revisamos otra vez el codigo fuente y vemos lo siguiente:
```
┌──(min㉿WIN-U49VUBQG3G3)-[~]
└─$ cat picker-III.py
...
```
podemos modificar la tabla simplemente sustituyendo el contenido de la funcion win() por el de una de las variables llamadas, esto por el comando exec() que se manda a llamar en la fuuncion write_variable:
```
┌──(min㉿WIN-U49VUBQG3G3)-[~]
└─$ nc saturn.picoctf.net 50727
==> 1
1: print_table
2: read_variable
3: write_variable
...
==> quit
```
ahora [convertimos](https://gchq.github.io/CyberChef/#recipe=From_Hex('Auto')&input=) otra vez de hexa a decimal para obtener la bandera:
```
