## Descripcion
I found this cipher in an old book. Can you figure out what it says? Connect with nc fickle-tempest.picoctf.net 61786.
## Solucion
entramos al server del reto y nos da el siguiente mensaje:
```
┌──(min㉿WIN-U49VUBQG3G3)-[~]
└─$ nc fickle-tempest.picoctf.net 61786
Encrypted message:
...
```
entramos a esta [pagina](www.guballa.de/vigenere-solver) y metemos el mensaje que obtuvimos, le damos a break cipher y obtenemos el siguiente mensaje:
...
la bandera queda asi:picoCTF{b311a50_0r_v1gn3r3_c1ph3rbc3a3Ae6}
## Notas
- 
## Referencias
- 
